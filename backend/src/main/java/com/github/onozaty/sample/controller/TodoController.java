...
public class TodoController {
  ...
  public List<Todo> findAll(@AuthenticationPrincipal UserPrincipal principal) {
    return todoService.findAll(principal.userId());
  }
  ...
  public ResponseEntity<Todo> create(
      @AuthenticationPrincipal UserPrincipal principal, @Valid @RequestBody TodoCreateInput input) {
    Todo created = todoService.create(principal.userId(), input);
    URI location =
  ...
  public ResponseEntity<Todo> update(
    ...
    Todo updated =
        todoService
            .update(principal.userId(), id, input)
  ...
  public ResponseEntity<Void> delete(
      @AuthenticationPrincipal UserPrincipal principal,
      @Parameter(description = "TODO ID", required = true) @PathVariable Long id) {
    if (!todoService.delete(principal.userId(), id)) {
